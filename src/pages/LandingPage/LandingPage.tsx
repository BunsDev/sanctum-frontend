    ...
    <>
      <IonPage>
        ...
        <IonContent className="landing-content ion-padding" fullscreen={true}>
          ...
          >
            Presenting SanctumLink protocol, a web3 KYC product that enhances
            users' experience with supported ecosystems without the hassle of
          ...
          <IonGrid>
            <IonRow>
              <IonCol>
                <IonButton expand="block" onClick={goLogin}>
                  Login
                </IonButton>
              </IonCol>
              <IonCol>
                <IonButton expand="block" onClick={goRegister}>
                  Register
                </IonButton>
              </IonCol>
            </IonRow>
          ...
          >
            <IonCard className="landing-card">
              ...
              <IonCardHeader>
                <IonCardTitle>
                  Making web3 available to general public
                </IonCardTitle>
                <IonCardSubtitle>Card Subtitle</IonCardSubtitle>
              </IonCardHeader>
              <IonCardContent>
